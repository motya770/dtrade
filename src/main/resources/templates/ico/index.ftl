...
<head>
	...
	<link rel="stylesheet" href="/ico/build/css/owl.carousel.min.css">
	<link rel="stylesheet" href="/ico/build/css/owl.theme.default.min.css">
...
<body>
			...
			<section class="diaminds">
				<div class="diaminds-wrapper wrapper">
					...
					<div class="diaminds-diamond">
						<div class="diaminds-diamond__circle diaminds-diamond__circle_1"></div>
						<div class="diaminds-diamond__circle diaminds-diamond__circle_2"></div>
						<div class="diaminds-diamond__circle diaminds-diamond__circle_3"></div>
					</div>
					<img src="/ico/build/img/nav-1.png" alt="nav" class="diaminds__nav">
				</div>
			</section>
				...
				<div class="about-us-wrapper wrapper">
					<div class="about-us-left">
						...
						<div class="about-us-left-diamonds" data-stellar-ratio="1.5" data-stellar-vertical-offset="200">
							...
							<img src="/ico/build/img/diamonds/3.png" alt="diamond" class="about-us-left-diamonds__img about-us-left-diamonds__img_3">
							<img src="/ico/build/img/diamonds/4.png" alt="diamond" class="about-us-left-diamonds__img about-us-left-diamonds__img_4">
							<img src="/ico/build/img/diamonds/5.png" alt="diamond" class="about-us-left-diamonds__img about-us-left-diamonds__img_5">
						</div>
					</div>
					...
					<img src="/ico/build/img/nav-2.png" alt="nav" class="about-us__nav">
				</div>
			</section>
  ...
  <script src="/ico/build/js/jquery-2.2.4.min.js"></script>
  <script src="/ico/build/js/jquery.stellar.js"></script>
  <script src="/ico/build/js/chartist.min.js"></script>
  <script src="/ico/build/js/owl.carousel.min.js"></script>
  <script src="/ico/build/js/jquery.mCustomScrollbar.concat.min.js"></script>
 <script src="/ico/build/js/jquery.fancybox.min.js"></script>
  <script src="/ico/build/js/main.js"></script>
    ...
    <script type="text/javascript">
        ...
        (function(){
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/5b15b1518859f57bdc7bd69d/default';
            s1.charset='UTF-8';
